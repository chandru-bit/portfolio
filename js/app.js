      ...
      h('section', { id: 'home', className: 'hero container' },
        h('div', { className: 'hero-left' },
          ...
          h('div', { className: 'hero-ctas' },
            ...
            h('a', { className: 'btn btn-outline', href: 'resume/Narmatha_Resume.pdf', target: '_blank' }, 'View Resume'),
            h('a', { className: 'btn btn-ghost', href: 'resume/Narmatha_Resume.pdf', download: true }, 'Download Resume'),
          ),
